 ...
 */
public class DZGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
     ...
     */
    public DZGLSurfaceView(Context context) {
        super(context);
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public DZGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * {@link DZGLSurfaceView#setEGLContextFactory(EGLContextFactory)}
     */
    ...
    public void setEglContext(EGLContext mEglContext) {
    ...
    private class DefaultContextFactory implements EGLContextFactory {
        ...
        public EGLContext createContext(EGL10 egl, EGLDisplay display, EGLConfig config) {
            ...
            if (mEglContext != null) {
                mEglContext = egl.eglCreateContext(display, config, mEglContext,
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link DZGLSurfaceView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link DZGLSurfaceView#setEGLConfigChooser(EGLConfigChooser)}
     */
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<DZGLSurfaceView> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            DZGLSurfaceView view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        private WeakReference<DZGLSurfaceView> mGLSurfaceViewWeakRef;
        EGL10 mEgl;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<DZGLSurfaceView> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
    ...
    private final WeakReference<DZGLSurfaceView> mThisWeakRef =
            new WeakReference<DZGLSurfaceView>(this);
